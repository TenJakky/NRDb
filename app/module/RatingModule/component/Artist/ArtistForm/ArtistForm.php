...
final class ArtistForm extends \Nepttune\Component\BaseComponent
{
    ...
    public function formSubmitted(\Nette\Application\UI\Form $form)
    {
        ...
        $this->getPresenter()->flashMessage('Artist successfully saved.', 'success');

        if ($this->getPresenter()->isAjax())
        {
            $this->getPresenter()->redrawControl('flash');
            return;
        }

        $this->getPresenter()->redirect('Artist:view', array('id' => $artist->id));
    }
}
